...
describe('actions inputs model', () => {
  ...
  test('title and hint refers to fencing for Action ID FG1', () => {
    ...
    expect(model.hint.text).toBe('How long is the fence you want to claim on in metres?')
  })
  ...
  test('title and hintrefers to acres for Action ID SW6', () => {
    ...
    expect(model.hint.text).toBe('What is the area you wish to claim on in hectares?')
  })
})
