...
const allParcels = [{ ref: '', description: 'Test parcel', totalPerimeter: 10, totalArea: 1 }]
...
describe('actions inputs model', () => {
  ...
  test('if error provided, should populate errorMessage', () => {
    ...
    const { model } = actionsInputsModel('', actions.fg6, error)
  ...
  test('if error isn\'t provided, errorMessage should be omitted', () => {
    const { model } = actionsInputsModel('', actions.fg6)
